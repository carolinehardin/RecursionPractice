//modified from https://courses.cs.washington.edu/courses/cse143/17wi/lectures/Sierpinski.java
// Program that draws the Sierpinski fractal.

import java.awt.*;
import java.util.*;

public class FractalBroken {
    ...
    public static void drawFigure(int level, Graphics g,
        ...
        if (level == 0) {
            ...
            drawFigure(level, g, p1, p4, p6);
            drawFigure(level, g, p4, p2, p5);
            drawFigure(level, g, p6, p5, p3);
        }
    }
